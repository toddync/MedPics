...
<div class="absolute top-0 right-0 inset-0 border-t-4">
	<div
		class="container translate-y-[70%] -translate-x-[30px] mx-auto mt-auto"
	>
		<div class="baton-0">
			<div class="metronome"><div class="baton"></div></div>
		</div>
		<div class="baton-1">
			<div class="metronome"><div class="baton"></div></div>
		</div>
